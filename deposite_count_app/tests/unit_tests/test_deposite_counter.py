...
@pytest.mark.parametrize("date, periods, amount, rate, res", [
    (
        "31.01.2021", 2, 10000, 6.0,
        {
            "31.01.2021": Decimal("10050.00"),
            "28.02.2021": Decimal("10100.25")
        }
    ),
    (
        "31.01.2020", 5, 100000, 6.0,
        {
