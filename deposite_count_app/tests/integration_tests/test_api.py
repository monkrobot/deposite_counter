...
@pytest.mark.parametrize(
    "date, periods, amount, rate, status_code, result",
    [
        ("31.01.2021", 2, 10000, 6.0, 200, {"31.01.2021": "10050.00", "28.02.2021": "10100.25"}),
        (
            "31-01-2021",
            2,
            10000,
        ...
        (
            ...
            6,
            400,
            {"detail": [{"error": "periods: Input should be less than or equal to 60"}]},
        ),
        (
            "31.01.2021",
            2,
            ...
            6,
            400,
            {"detail": [{"error": "amount: Input should be greater than or equal to 10000"}]},
        ),
        (
            "31.01.2021",
            2,
            ...
            66,
            400,
            {"detail": [{"error": "rate: Input should be less than or equal to 8"}]},
        ),
        (
            "31-01-2021",
            100,
